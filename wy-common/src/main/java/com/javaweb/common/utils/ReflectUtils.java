...
public class ReflectUtils {
    ...
    private static ConcurrentMap<String,List<Field>> fieldsCacheMap = new ConcurrentHashMap<>();
    ...
    public static List<Field> getAllFields(Class clazz) {
        ...
        if (null == fieldsCacheMap.get(clazzName)) {
            List<Field> fieldList = new ArrayList<>();
            while (clazz != null) {
                fieldList.addAll(new ArrayList<>(Arrays.asList(clazz.getDeclaredFields())));
                clazz = clazz.getSuperclass();
            }
            fieldsCacheMap.put(clazzName,fieldList);
            return fieldList;
        }else
            return fieldsCacheMap.get(clazzName);
    }
