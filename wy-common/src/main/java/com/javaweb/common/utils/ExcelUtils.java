...
public class ExcelUtils<T> {
     ...
     * @return 结果
     */
    public JsonResult exportExcel(List<T> list, String sheetName,String uploadFolder) {
        this.init(list, sheetName, Excel.Type.EXPORT);
        return exportExcel(uploadFolder);
    }
     ...
     * @return 结果
     */
    public JsonResult importTemplateExcel(String sheetName,String uploadFolder) {
     ...
     * @return 结果
     */
    public JsonResult exportExcel(String uploadFolder) {
        ...
        try {
            ...
            out = new FileOutputStream(getAbsoluteFile(filename,uploadFolder));
            wb.write(out);
    ...
    public void fillExcelData(int index, Row row) {
        ...
        for (int i = startNo; i < endNo; i++) {
            newRow = sheet.createRow(i + 1 - startNo);
            // 得到导出对象.
            T vo = (T) list.get(i);
            int column = 0;
            for (Object[] os : fields) {
                ...
                // 设置实体类私有属性可访问
                field.setAccessible(true);
                this.addCell(excel, newRow, vo, field, column++);
            }
        }
    }
     ...
     * @throws Exception
     */
    public static String convertByExp(String propertyValue, String converterExp) throws MyWebException {
        try {
     ...
     * @throws Exception
     */
    public static String reverseByExp(String propertyValue, String converterExp) throws MyWebException {
        try {
            String[] convertSource = converterExp.split(",");
            for (String item : convertSource) {
                String[] itemArray = item.split("=");
     ...
     * @param filename 文件名称
     */
    public String getAbsoluteFile(String filename,String uploadFolder) {
        String downloadPath = uploadFolder + filename;
