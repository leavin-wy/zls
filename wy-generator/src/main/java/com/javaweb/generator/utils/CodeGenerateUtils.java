...
public class CodeGenerateUtils {
    ...
    private void generateIndexFile(Map<String, Object> dataMap) throws Exception {
        // 文件路径
        String path = projectPath + "/"+moduleName+"/src/main/resources/templates/" + entityName.toLowerCase() + "/";
        // 初始化文件路径
        initFileDir(path);
        // 文件后缀
        String suffix = ".html";
    ...
    private void generateJsFile(Map<String, Object> dataMap) throws Exception {
        // 文件路径
        String path = projectPath + "/"+moduleName+"/src/main/resources/static/module/";
        // 初始化文件路径
        initFileDir(path);
        // 文件后缀
        String suffix = ".js";
